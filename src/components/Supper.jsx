...
import supperImg11 from "../assets/Images/img11.png";
import supperImg12 from "../assets/Images/img12.png";
import supperImg13 from "../assets/Images/img13.png";
import supperImg14 from "../assets/Images/img14.png";
    ...
    <div ref={containerRef} className="fourth-color">
      ...
      <div className="second relative w-full h-screen flex items-center justify-center">
        <div className="flex absolute top-0 gap-50 items-start">
          <img className="z-2" src={supperImg11} alt="" />
          <img className="mt-25 z-0" src={supperImg12} alt="" />
        </div>
      </div>
      <div className="relative third w-full h-screen flex items-center justify-center">
        <div className="flex absolute top-0 gap-50 items-start">
          <img className="z-0" src={supperImg13} alt="" />
          <img className="z-2 mt-25" src={supperImg14} alt="" />
        </div>
      </div>
    </div>
  );
